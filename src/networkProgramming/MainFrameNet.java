...
public class MainFrameNet extends JFrame {
	...
	{ 
		...
		textAreaIncoming.append(senderName +  " ("   + address + "): " +  message + "\n"); }
				...
				{ e.printStackTrace(); JOptionPane.showMessageDialog (MainFrameNet.this,"Ошибкавработесервера", "Ошибка", JOptionPane.ERROR_MESSAGE); 
				} } }).start();
	}
	...
	private void sendMessage() {
		try{ 
			...
			{ JOptionPane.showMessageDialog(this,"Введитеадресузла-получателя", "Ошибка", JOptionPane.ERROR_MESSAGE); 
			return;}
			
			if   (message.isEmpty()) 
			{ JOptionPane.showMessageDialog(this, "Введитетекстсообщения", "Ошибка", JOptionPane.ERROR_MESSAGE); 
			return;}
		...
		{ e.printStackTrace(); 
		JOptionPane.showMessageDialog(MainFrameNet.this,
				"Не удалосьотправить сообщение: узел-адресат не найден",
				"Ошибка", JOptionPane.ERROR_MESSAGE); 
		} catch(IOException e) 
		{ e.printStackTrace(); JOptionPane.showMessageDialog(MainFrameNet.this,
	...
	{ SwingUtilities.invokeLater (new Runnable() 
			{ @Override public void run() 
			{ final MainFrameNet frame = new MainFrameNet(); 
